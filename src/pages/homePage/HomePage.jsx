...
<div className={styles.d}>
  <div className={styles.dog2} style={{backgroundImage: `url(${dog2})`}}>
    <div className={styles.align2}>
      <p className={styles.p1}>Your one-stop destination for your favourite puppy.</p>
      <p className={styles.p2}>We provide you with quality and healthy puppies to keep you </p>
      <p>company and add fun to your everyday life.</p>
    </div>
  </div>
  <div className={styles.dog3} style={{backgroundImage: `url(${dog3})`}}>
  ...
  <div className={styles.dog3} style={{backgroundImage: `url(${dog4})`}}>
...
<div className={styles.align4}>
    <div className={styles.dog5} style={{backgroundImage: `url(${dog9})`}}>
      <div className= {styles.d1}>
        Tibetan Terrier
      </div>
    </div>
    <div className={styles.dog5} style={{backgroundImage: `url(${dog10})`}}>
      <div className= {styles.d2}>
        Rottweiler
      </div>
    </div>
    <div className={styles.dog5} style={{backgroundImage: `url(${dog11})`}}>
      <div className= {styles.d1}>
        German Shepherd
      </div>
    </div>
    ...
    <div className={styles.align4}>
    <div className={styles.poodle} style={{backgroundImage: `url(${poodle})`}}>
    <img src={comingsoon} alt='writeup' className={styles.coming}></img>
    </div>
    <div className={styles.poodle} style={{backgroundImage: `url(${irish})`}}>
    <img src={comingsoon} alt='writeup' className={styles.coming}></img>
    </div>
    <div className={styles.poodle} style={{backgroundImage: `url(${dachshund})`}}>
    <img src={comingsoon} alt='writeup' className={styles.coming}></img>
    </div>
    </div>
